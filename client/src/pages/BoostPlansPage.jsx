...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "چرخش روزانه در صفحهٔ اصلی + همیشه در بخش ویژهٔ آگهی‌ها",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "چرخش روزانه در صفحهٔ اصلی + همیشه بالاتر از پلاتینیوم در بخش ویژه",
    ],
    notIncluded: [],
  },
];
        ...
        <section style={{ marginBottom: "3.5rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px,1fr))", gap: "1rem" }}>
            {[
              ...
              { step: "۴", title: "چرخش روزانه", desc: "اگر چند کسب‌وکار پلن یکسانی داشته باشند، ترتیب نمایش هر روز به‌صورت خودکار تغییر می‌کند — در بخش آگهی‌ها همه نمایش داده می‌شوند." },
            ].map((item) => (
        ...
        <section style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
            {[
              ...
              { rank: 2, icon: "💎", label: "پلاتینیوم", desc: "زیر الماسی — همهٔ پلاتینیوم‌ها در آگهی‌های ویژه نمایش داده می‌شوند؛ ترتیب روزانه چرخش می‌کند.", color: "#7c3aed" },
            ...
            {[
              {
                ...
                a: "همهٔ ۱۰ کسب‌وکار همیشه در بخش «آگهی‌های ویژه» صفحهٔ آگهی‌ها نمایش داده می‌شوند. در صفحهٔ اصلی، تعداد محدودی جایگاه وجود دارد — ترتیب هر روز به‌صورت خودکار تغییر می‌کند تا همه به‌طور عادلانه نمایش داده شوند. هیچ‌کس حذف نمی‌شود.",
              },
              {
              ...
              {
                q: "چه مدت بعد از اتمام بوست می‌توانم دوباره بوست بگیرم؟",
                a: "هر پلن یک دورهٔ انتظار (Cooldown) دارد: نقره‌ای ۱۴ روز، طلایی ۲۸ روز، پلاتینیوم ۴۲ روز، الماسی ۵۶ روز. پس از پایان دوره انتظار می‌توانید مجدداً بوست فعال کنید.",
              },
              {
